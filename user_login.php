...
// Already logged in as user? Go to user dashboard
...
body{
  ...
  color:var(--t);display:flex;flex-direction:column;min-height:100vh
}
...
<div class="split">
  <div class="sl">
    <div class="pill"><span class="pdot"></span>Donor Portal</div>
    <h1>Welcome<br><em>Back,</em>Donor</h1>
    <p>Sign in to access your donation history and manage your donor profile.</p>
    <ul class="perks">
        <li><span class="perk-dot"></span>View your donation ticket history</li>
        <li><span class="perk-dot"></span>Track your contribution over time</li>
        <li><span class="perk-dot"></span>Update your personal information</li>
    </ul>
  </div>
  <div class="sr">
  <div class="card">
    <div class="ctitle">Sign In</div>
    <div class="csub">Enter your donor account credentials</div>
    <?php if($error):?><div class="aerr">⚠ <?=htmlspecialchars($error)?></div><?php endif;?>
    <form method="POST">
        <div class="field"><label>Username</label><input type="text" name="username" placeholder="Your username" required autocomplete="username"></div>
        <div class="field"><label>Password</label><input type="password" name="password" placeholder="Your password" required autocomplete="current-password"></div>
        <button class="sbtn" name="login">Sign In →</button>
    </form>
    <hr class="div">
    <div class="foot">
        <a href="register1.php">Don't have an account? Register here</a>
